...
%
%   [F,D,GSS,DOG,GRAD] = VL_SIFT(I) optionaly exports the gaussian scale
%   space GSS of the image I, difference of gaussians DOG and array with
%   gradients amplitudes and angles of GSS GRAD planes used for calculation
%   of the SIFT descriptors. GSS, DOG and GRAD are structures with format:
%
%     o_idxs: [o_min : o_max]
%     s_idxs: [s_min : s_max]
%       data: {o_num x s_num cell}
%
%   where o_min and o_max are indexes of the octaves (if the input image 
%   was upsampled, o_min < 0) and s_min and s_max are indexes of levels,
%   usually s_min = -1 and s_max = Levels:: + 2 in the case of GSS.
%
%
